...
const easyLayouts: OBRLayout[] = [
  ...
  makeLayout("easy", 2, "Duas cores, uma decisão", "Passe pela estação azul e só finalize quando encontrar a estação amarela.", "Guarde a primeira cor na lógica: amarelo antes de azul não vale como final.",
    [{x:70,y:510},{x:210,y:510},{x:270,y:450},{x:270,y:380},{x:390,y:380},{x:455,y:315},{x:590,y:315}],
    { floorMarkers:[m("e2-blue","1","azul",270,420),m("e2-yellow","2","amarelo",590,315,32,36)], hazards:[h("e2-check","Estação azul reconhecida",270,420)], requiredHazards:["e2-check"], goal:goal(590,315,"Passe pelo azul e pare no amarelo"), timeLimit:100 }),
  makeLayout("easy", 3, "Pontes sobre o vazio", "Atravesse três falhas da linha e pare na estação azul depois da última ponte.", "Ao ler branco, mantenha por pouco tempo a última correção em vez de procurar uma curva inexistente.",
    [{x:70,y:510},{x:250,y:510},{x:310,y:450},{x:430,y:450},{x:490,y:390},{x:610,y:390}],
    { gaps:[{x:145,y:495,width:45,height:30},{x:333,y:435,width:42,height:30},{x:515,y:375,width:42,height:30}], floorMarkers:[m("e3-blue","FIM","azul",610,390,32,36)], hazards:[ev("e3-a","gap","Primeiro gap superado",210,510),ev("e3-b","gap","Segundo gap superado",395,450),ev("e3-c","gap","Terceiro gap superado",570,390)], requiredHazards:["e3-a","e3-b","e3-c"], goal:goal(610,390,"Supere os 3 gaps e pare no azul"), timeLimit:110 }),
  makeLayout("easy", 4, "Espelho de curvas", "Complete curvas alternadas sem sair do traçado e chegue ao alvo vermelho.", "Compare os dois sensores; a correção de uma curva deve funcionar invertida na seguinte.",
    [{x:70,y:510},{x:165,y:510},{x:215,y:460},{x:165,y:410},{x:215,y:360},{x:165,y:310},{x:300,y:310},{x:355,y:365},{x:410,y:310},{x:465,y:365},{x:610,y:365}],
    { floorMarkers:[m("e4-red","FIM","vermelho",610,365,32,36)], goal:goal(610,365,"Pare após todas as curvas"), maxCollisions:0, timeLimit:80 }),
